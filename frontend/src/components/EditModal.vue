...
<template>
  <el-dialog :model-value="visible" :before-close="beforeClose" class="el-dark" width="1000px"
    ...
    <el-form :label-width="formLabelWidth ?? '120px'" style="width: 900px; overflow: auto;"
             v-loading="formLoading" element-loading-background="rgba(20, 20, 20, 0.8)"
             :model="formModel" ref="form" :rules="formRules">

      <slot name="form"/>

      <div style="margin-top: 10px; float: right;">
        <el-button :icon="Close" @click="beforeClose">Cancel</el-button>
        <el-button type="primary" :icon="Check" @click="emit('submit')" :loading="isSaving">Save</el-button>
      </div>
    </el-form>
  </el-dialog>
</template>
